...
Once the `conda-forge` channel has been enabled, `pickledb` can be installed with:

```
conda install pickledb
```

It is possible to list all of the versions of `pickledb` available on your platform with:
